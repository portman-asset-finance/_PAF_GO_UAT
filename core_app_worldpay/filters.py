import datetime
from core_agreement_crud.models import go_agreement_querydetail, go_account_transaction_summary, go_customers
from core.models import ncf_arrears_summary, ncf_dd_schedule
...
class go_customers_Filter(django_filters.FilterSet):
